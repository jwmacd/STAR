...
<!-- - Download the proposed STAR from [HuggingFace](https://huggingface.co/stabilityai/stable-diffusion-2-base). -->
<!-- - Download the CLIP models from [HuggingFace](https://huggingface.co/laion/CLIP-ViT-H-14-laion2B-s32B-b79K/resolve/main/open_clip_pytorch_model.bin?download=true). -->

You can put the model into `pretrained_weight/`.


#### Step 2: Prepare testing data
You can put the testing videos in the `input/video/`.

You have three options for the prompt: 1. No prompt. 2. Automatically generate a prompt [using Pllava](https://github.com/hpcaitech/Open-Sora/tree/main/tools/caption#pllava-captioning). 3. Manually input a prompt. You can put the txt file in the `input/text/`.
